...
export default class Channel extends Component {
    ...
    componentDidUpdate(prevProps){
        const channelChange = this.props.match.params.id !== prevProps.match.params.id
        if (channelChange || this.props.channels.length !== prevProps.channels.length){
    ...
    render() {
        if (this.state.redirect) return <Redirect to={`/${this.props.match.params.name}`}></Redirect>
