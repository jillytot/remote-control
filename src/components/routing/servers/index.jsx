...
export default class ServersPage extends Component {
    ...
    render(){
        ...
        if (this.state.user === null) return <Redirect to="/login"></Redirect>
            ...
            loadingText ? (
                ...
                <React.Fragment>
                    ...
                    <div className="server-container">
                        <RobotServer modal={this.setModal} onCloseModal={this.onCloseModal} user={this.state.user} robotServers={this.state.robotServers} selectedServer={this.state.selectedServer}></RobotServer>
                        <Switch>
                            <Route path="/:name" render={(props) => (<ServerPage {...props} modal={this.setModal} onCloseModal={this.onCloseModal} user={this.state.user} robotServers={this.state.robotServers} selectedServer={this.state.selectedServer} setServer={this.setServer}></ServerPage>)}></Route>
                            <Route path="/" render={(props) => (<NoServerPage {...props} setServer={this.setServer}></NoServerPage>)}></Route>
                        </Switch>
                    </div>
                </React.Fragment>
            )
